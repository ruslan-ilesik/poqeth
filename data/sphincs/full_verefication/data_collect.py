...
file_path = os.path.join(script_dir, '../../../test/sphincsPlus/sphincsPlus.sol')
...
# The range for each parameter (security 1 approximately)
h_range =   range(63, 64)  
d_range =   range(10, 20)   
a_range =   range(12, 100)   
k_range =   range(14, 60)  
# the results.cvs range of arguments
h_range = range(1, 20)  
d_range = range(2, 10)  
a_range = range(1, 64)  
k_range = range(1, 64)  
            ...
            for a in a_range:
                ...
                for k in k_range:
                    ...
                    if check_condition(h, d, a, k, m_value) and (h - h // d) > 0 and h > d:
                        ...
                        command = ["forge", "test", "--gas-report", "--via-ir", "-vvv", "--match-path", "test/sphincsPlus/sphincsPlus.sol"]
